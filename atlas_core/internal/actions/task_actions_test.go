...
func TestTaskStatusTransitionUpdateRemovesLegacyExtra(t *testing.T) {
	...
	removeBlobExtraKeys(existing, models.TaskPromotedBlobFields, params.RemoveExtraKeys...)
	...
	removeBlobExtraKeys(nilExisting, models.TaskPromotedBlobFields, nilParams.RemoveExtraKeys...)
	for _, key := range legacyTaskTransitionExtraKeys {
