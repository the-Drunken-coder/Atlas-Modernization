...
describe("sidebar reducer", () => {
  ...
  it("switches to inspector mode when an entity is selected and remembers the list", () => {
    ...
    const selected = sidebarReducer(onTracks, { type: "selectEntity", kind: "track", id: "track-1", origin: "sidebar" });
  ...
  it("keeps selection single-select", () => {
    let state = sidebarReducer(initialSidebarState, { type: "selectEntity", kind: "asset", id: "asset-1", origin: "sidebar" });
  ...
  it("claims the camera for sidebar selections and bumps the sequence on re-select", () => {
    const first = sidebarReducer(initialSidebarState, { type: "selectEntity", kind: "asset", id: "asset-1", origin: "sidebar" });
  ...
  it("does not claim the camera for map selections", () => {
    const fromSidebar = sidebarReducer(initialSidebarState, { type: "selectEntity", kind: "asset", id: "asset-1", origin: "sidebar" });
  ...
  it("releases the camera claim when the selection clears", () => {
    const selected = sidebarReducer(initialSidebarState, { type: "selectEntity", kind: "asset", id: "asset-1", origin: "sidebar" });
  ...
  it("returns to the previous list with back and clearSelection", () => {
    ...
    const selected = sidebarReducer(onGeo, { type: "selectEntity", kind: "geofeature", id: "geo-1", origin: "sidebar" });
