...
`Atlas Protocol/` is currently a planning/documentation folder, not an implemented module. If you turn it into generated code that Atlas Core imports, decide the module/import boundary first; the repository currently has only `Atlas_Core/go.mod`.
