...
const budgets = {
  ...
  // draft lifecycle, and the purpose-built flight command forms and telemetry.
  // The forms bring the shell to 166.20 kB raw / 52.81 kB gzip.
  shellJavaScript: { raw: 167_000, gzip: 53_000 },
