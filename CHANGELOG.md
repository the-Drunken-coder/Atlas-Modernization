...
These are historical Atlas Core release notes through 0.2.1. New release notes live in GitHub Releases; the current
tag-based release workflow does not edit this file.
...
- At 0.1.0, releases used a manually dispatched workflow that created a reviewed release commit and immutable tag before publication. The current process is documented in `docs/atlas-core/RELEASING.md`.
