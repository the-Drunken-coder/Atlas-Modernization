...
7. **Actual:** The 210-line dispatcher contains query pagination, entity/task/object routing, request validation, precondition handling, and error responses. Biome 2.5.3 reports cognitive complexity 86 for `FakeCore.fetch`.
8. **Reproduction:**
...
9. **Notes:** Verified against `main` at `a8b73d7` with Biome 2.5.3 on 2026-07-24. Extract only the existing route families into private methods; do not introduce a general-purpose router or change the fake's behavior.
