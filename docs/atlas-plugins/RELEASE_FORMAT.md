...
see [bootstrap provenance](CATALOG_BOOTSTRAP.md). The signed stable catalog is published. The approved first TUI version keeps update, rollback, uninstall, catalog refresh, and shared-key rotation as direct commands; see [GitHub issue #359](https://github.com/the-Drunken-coder/Atlas-Modernization/issues/359).
