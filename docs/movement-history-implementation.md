...
Protocol artifact checks and Go tests, 511 SDK tests in both Node and Chromium, SDK type tests, all 443 Radio tests and all 22 history UI tests pass. SDK and Command typechecks and builds pass. The explicit schema variants slightly enlarge the generated runtime validators: the measured initial JavaScript is 430.57 kB raw and the total is 3,653.48 kB. Their raw limits each increase by 1 kB; compressed-size limits remain unchanged.
