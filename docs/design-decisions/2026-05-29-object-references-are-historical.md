...
7. **Location:** `Atlas_Core/internal/database/db.go` (`objects` table), `Atlas_Core/internal/actions/object_actions.go` (`referenced_by` handling), `Atlas_Core/internal/actions/entity_actions.go` (`Delete`)
