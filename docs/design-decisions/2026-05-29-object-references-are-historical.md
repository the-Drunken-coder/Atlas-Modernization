...
7. **Location:** `services/core/internal/database/db.go` (`objects` table), `services/core/internal/actions/object_actions.go` (`referenced_by` handling), `services/core/internal/actions/entity_actions.go` (`Delete`)
