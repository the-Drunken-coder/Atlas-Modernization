...
7. **Location:** `Atlas_Core/internal/database/db.go` (`objects` table), `Atlas_Core/internal/actions/objectactions/references.go` (`referenced_by` handling), `Atlas_Core/internal/actions/entityactions/update.go` (`Delete`)
