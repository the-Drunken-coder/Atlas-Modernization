...
7. **Location:** `services/core/internal/database/migrations.go`, `services/core/internal/database/schema_fingerprint.go`, `services/core/internal/database/db.go`, `services/core/cmd/atlas_core/main.go`, `services/core/docker/docker-compose.yml`, `services/core/docker/docker-compose.production.yml`, `services/core/docker/production-entrypoint.sh`, and `services/core/docs/DEPLOYMENT_RUNBOOK.md`.
