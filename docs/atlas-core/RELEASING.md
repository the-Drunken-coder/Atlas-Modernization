...
UI redesign is approved and tracked in [GitHub issue #359](https://github.com/the-Drunken-coder/Atlas-Modernization/issues/359); the released CLI remains unchanged. Production Plugin signing trust and Pages configuration are recorded in
