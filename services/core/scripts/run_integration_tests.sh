...
#   ATLAS_CORE_API_URL=http://localhost:8000 ./services/core/scripts/run_integration_tests.sh
# or, from within services/core/scripts/:
#   ATLAS_CORE_API_URL=http://localhost:8000 ./run_integration_tests.sh
# For authenticated deployments:
#   API_AUTH_KEY=... ATLAS_CORE_API_URL=http://localhost:8000 ./services/core/scripts/run_integration_tests.sh
#
# Requires: curl, jq
