...
EXPECTED = {
    ...
    "github.com/the-drunken-coder/atlas/services/core/internal/actions": {
        ...
        "TestFlightGotoSupersedesActiveGoto",
        "TestFlightRecoverySupersedesTakeoffAndGoto",
        "TestFlightTakeoffDoesNotSupersedeGoto",
        "TestFlightGotoDuringTakeoffIsRejected",
        "TestFlightCommandInputValidation",
    },
    "github.com/the-drunken-coder/atlas/services/core/internal/api/handlers": {
        "TestEntityCheckinMergesFlatAndComponentTelemetry",
