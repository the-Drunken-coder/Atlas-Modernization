...
func loadTaskingFixture[T any](t testing.TB, name string) T {
	...
	switch name {
	case "catalog.json":
		encoded, err = os.ReadFile("../../../../packages/protocol/conformance/tasking/fixtures/catalog.json")
	case "manifest.json":
		encoded, err = os.ReadFile("../../../../packages/protocol/conformance/tasking/fixtures/manifest.json")
	default:
