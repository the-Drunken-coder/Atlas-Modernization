...
func taskingHandlerFixture[T any](t *testing.T, name string) T {
	...
	switch name {
	case "catalog.json":
		data, err = os.ReadFile("../../../../../packages/protocol/conformance/tasking/fixtures/catalog.json")
	case "manifest.json":
		data, err = os.ReadFile("../../../../../packages/protocol/conformance/tasking/fixtures/manifest.json")
	default:
